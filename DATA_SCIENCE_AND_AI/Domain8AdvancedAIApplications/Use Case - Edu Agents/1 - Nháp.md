...
sequenceDiagram
  ...
  participant A as M365 Agent SDK Host
  participant O as Orchestrator
  participant G as Microsoft Graph

  U->>A: Gửi tin nhắn "Tóm tắt email hôm nay"
  A->>O: Forward activity + context
  O->>G: /me/messages (filter hôm nay)
  G-->>O: Danh sách email
  O-->>A: Tóm tắt + action
  A-->>U: Adaptive Card hiển thị kết quả
```

...
## OrbStack - Giải pháp thay thế Docker Desktop cho macOS
...
- Nếu `commands.sh` thì là lệnh chạy 1 chuỗi lệnh trong WSL.
- Còn docker compose thì thôi, ra window mà chạy, vì nó có Docker Desktop check file docker-compose ngon.

### Lưu ý về Deprecation Warning

Khi chạy `docker compose`, có thể gặp cảnh báo về Docker Image Format v1:

```
[DEPRECATION NOTICE] Docker Image Format v1 and Docker Image manifest version 2, schema 1 support is disabled by default and will be removed in an upcoming release.
```

Điều này không ảnh hưởng đến việc sử dụng, nhưng nên cập nhật các image cũ lên OCI Format hoặc Docker Image manifest v2, schema 2.

...
output: 40 trang siêu chi tiết từng phần (Đếm đủ 40 trang chi tiết chưa nhé) 
```



```
 pasted_content.txt là toàn bộ tài liệu về Product của 1 hệ thống Robot, giúp tớ hoàn thành checklist sau 
1. Đọc chi tiết toàn bộ product design trên, reasoning về nó 

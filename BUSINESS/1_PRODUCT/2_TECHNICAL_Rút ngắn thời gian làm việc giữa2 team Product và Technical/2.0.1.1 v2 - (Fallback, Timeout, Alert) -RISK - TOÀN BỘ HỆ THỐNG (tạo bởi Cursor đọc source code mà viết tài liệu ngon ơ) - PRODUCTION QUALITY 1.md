	...
	**Total: 47 alert types**
	...
	1. **LLM_TIMEOUT**
	2. **LLM_RATE_LIMIT**
	3. **WORKFLOW_EXECUTION_FAILURE**
	4. **WORKFLOW_TIMEOUT**
	5. **AGENT_EXECUTION_FAILURE**
	6. **AGENT_TIMEOUT**
	7. **REDIS_OPERATION_TIMEOUT**
	8. **REDIS_WRITE_FAILURE**
	9. **REDIS_POOL_EXHAUSTED**
	10. **POSTGRES_WRITE_FAILURE**
	11. **KAFKA_PRODUCER_FAILURE**
	12. **KAFKA_SEND_TIMEOUT**
	13. **WEBHOOK_PROCESSING_FAILURE**
	14. **API_REQUEST_TIMEOUT**
	15. **SUSPICIOUS_ACTIVITY**
	16. **CONTAINER_UNHEALTHY**
	
	######## MEDIUM Level (21 types)
	
	17. **LLM_TOKEN_LIMIT_EXCEEDED**
	18. **LLM_MALFORMED_RESPONSE**
	19. **LLM_CONTEXT_OVERFLOW**
	20. **LLM_STREAMING_ERROR**
	21. **AGENT_NOT_FOUND**
	22. **AGENT_INVALID_OUTPUT**
	23. **POSTGRES_QUERY_TIMEOUT**
	24. **EXTERNAL_API_TIMEOUT**
	25. **EXTERNAL_API_ERROR**
	26. **RESPONSE_SERIALIZATION_ERROR**
	27. **RESPONSE_SIZE_EXCEEDED**
	28. **INVALID_REQUEST_PAYLOAD**
	29. **AUTH_FAILURE**
	30. **RATE_LIMIT_EXCEEDED**
	31. **PAYLOAD_SIZE_EXCEEDED**
	32. **INVALID_JSON_FORMAT**
	33. **MISSING_REQUIRED_FIELDS**
	34. **HIGH_MEMORY_USAGE**
	35. **HIGH_CPU_USAGE**
	36. **DISK_SPACE_LOW**
	37. **HIGH_NETWORK_LATENCY**
	...
	**Secondary Goals:**
	...
	6. Giảm code duplication từ 69 occurrences → < 10
	7. Tạo reusable components (helpers, decorators)
	8. Support multiple notification channels (extensible)
	9. Implement rate limiting và deduplication
	...
	**Exception:**
	...
	3. get_api_key() được gọi:
	   - Check ENVIRONMENT == "local"?
	     ...
	     → NO: Continue
	   ↓
	1. Check API key từ header (x-api-key) hoặc query (api_key)
	   ↓
	2. So sánh với settings.SECRET_KEY
	   ↓
	3. Nếu khớp:
